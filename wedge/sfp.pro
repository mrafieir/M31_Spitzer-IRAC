...
case mode of
0: map = mrdfits('~/Projects/project_80032/pr_maps/I1EW.fits', 0, header)
1: map = mrdfits('~/Projects/project_80032/pr_maps/I1NS.fits', 0, header)
;0: map = mrdfits('~/Projects/project_80032/maps/I1_M31.EW.big_mosaic.fits', 0, header)
;1: map = mrdfits('~/Projects/project_80032/maps/I1_M31.NS.noCRs_mosaic.fits', 0, header)
endcase
...
readcol, '~/Projects/project_80032/pr_maps/I1NS_mask.dat', xi, xf, yi, yf, comment='#'
