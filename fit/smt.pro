...
background = mrdfits('~/Projects/project_80032/NEW/finalbg_I1NS.fits')
...
stop
fxwrite, '~/Projects/project_80032/NEW/I1NS_background_smooth.fits', header, $
	float(background_smooth)
fxwrite, '~/Projects/project_80032/NEW/I1NS_final_smooth.fits', header, float(cleaned)
